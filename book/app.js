...
(function () {
  ...
  function App() {
    ...
    var sharedTourCard = SECTIONS.sharedTourCard && h(
      ...
      h(
        "div", { className: "h-21 relative overflow-hidden" },
    ...
    var campingCard = false; // Camping package removed from the packages page —
    // kept as `false` so any stray reference elsewhere renders nothing.
    ...
    var page1 = page === 1 && h(
      ...
      h("div", { className: "grid md:grid-cols-2 gap-6 max-w-[820px] mx-auto" }, sharedTourCard, privatePackageCard),
